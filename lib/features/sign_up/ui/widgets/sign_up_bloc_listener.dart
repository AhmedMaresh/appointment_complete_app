...
import 'package:appointment_complete_flutter_app/features/sign_up/logic/cubit/sign_up_state.dart';
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              child: Text('Continue', style: TextStyles.font14LightGreyRegular),
            ),
          ],
        );
      },
